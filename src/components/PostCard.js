        ...
        <div className='card_block'>
          ...
          <Card border="primary" className="cardContainer" style={{ width: '35rem' }}>
            ...
            <Card.Body className='card_body'>
                ...
                {id ? <div className='card_description'>{article.fields.description}</div> : (<Card.Text className='read_link'><Link to={`/${article.sys.id}`}>Read article</Link></Card.Text>)}
                {/* <Card.Text className='card_descrption'>{article.fields.description}</Card.Text> */}
                <Card.Text className='card_nameAuthor'><i>by: {article.fields.nameOfAuthor}</i></Card.Text>
                <Card.Link className='card_link' href="#" onClick={handleClick}>Share</Card.Link>
